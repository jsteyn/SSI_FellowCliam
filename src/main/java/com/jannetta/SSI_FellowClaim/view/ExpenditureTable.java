 ...
 */
public class ExpenditureTable extends JTable {
...
//
     ...
     */
    public ExpenditureTable(TableModel dm) {
        this(dm, null, null);
    }
     ...
     */
    public ExpenditureTable(TableModel dm, TableColumnModel cm) {
        this(dm, cm, null);
    }
     ...
     */
    public ExpenditureTable(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
        super(dm, cm, sm);
    }
     ...
     */
    public ExpenditureTable(int numRows, int numColumns) {
     ...
     */
    public ExpenditureTable(Vector rowData, Vector columnNames) {
     ...
     * @param columnNames names of each column
     */
    public ExpenditureTable(final Object[][] rowData, final Object[] columnNames) {
