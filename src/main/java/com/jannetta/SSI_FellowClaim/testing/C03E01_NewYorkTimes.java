...
public class C03E01_NewYorkTimes {
    ...
    public static final String DEST = "data/new_york_times.pdf";

    public static final String APPLE_IMG = "data/ny_times_apple.jpg";
    public static final String APPLE_TXT = "data/ny_times_apple.txt";
    public static final String FACEBOOK_IMG = "data/ny_times_fb.jpg";
    public static final String FACEBOOK_TXT = "data/ny_times_fb.txt";
    public static final String INST_IMG = "data/ny_times_inst.jpg";
    public static final String INST_TXT = "data/ny_times_inst.txt";
